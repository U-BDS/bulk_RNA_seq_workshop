...
> ```
>
> `run_rnaseq.sh` would need to increase the time allocation to better fit the analysis. For the downsample, it was set to 1hr so buffing it to 12hr should fit most analyses
> 
> ``` run_rnaseq.sh
> #!/usr/bin/env bash
> 
