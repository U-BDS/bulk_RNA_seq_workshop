...
2.  Cheaha comes with a lot of tools and software pre-installed called 'modules'. Anaconda is one of these tools, and we can load it using the below command:
...
5.  Inside the environment, install Nextflow and nf-core as these will be needed in order to run the pipeline
